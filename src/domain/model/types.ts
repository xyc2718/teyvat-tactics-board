...
export type RoleId = 'water' | 'fire' | 'ice' | 'geo' | 'electro'
export type BasicRoleId = RoleId | 'anemo'
...
export type TimingTargetReference = MoveKeyframeReference
  | { playerId: string; actionId: string; event: 'qReady' | 'eReady' | 'qBoost' | 'receiveBoost' | 'freeze'; edge: 'start' | 'end' }
...
export interface MoveAction extends BaseAction {
  ...
  actorId: string
  path: Vec2[]
  /** Electro E: constant rule speed, finite energy, no ordinary movement effects. */
  sprint?: true
  /** Provenance of an E stop generated by a catch; not a tail/deletion dependency. */
  sprintReceptionSourceId?: string
...
export interface ProjectedFrame extends SceneState {
  ...
  shots: ShotState[]
  sprints?: Record<string, ElectroSprintState>
}

export interface ElectroSprintState {
